...
incoming email while they're away. Note: binary file included in this
package must be suid.

%description -l pl
Ta wtyczka umo¿liwia u¿ytkownikom stworzenie i w³±czenie automatycznej
odpowiedzi na wszystkie przychodz±ce maile. Uwaga: plik binarny
zawarty w tym pakiecie musi mieæ ustawiony bit suid.
...
%doc INSTALL README
%attr(755,root,root) %{_sbindir}/squirrelmail_vacation_proxy
